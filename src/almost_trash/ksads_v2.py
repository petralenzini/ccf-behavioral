...
def main():
    for item in assessments:
        # Download latest files for each site - make sure they exist.  send up
        # warning if they dont
...
combo_before = combo_before[['ID', 'PatientID',
    'PatientType', 'subject', 'SiteName']].copy()
