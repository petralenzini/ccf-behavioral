...
cat_filescores = os.path.join(store_space,'CatToolBoxAssessmentFiles_Scores.csv')
cat_fileraw = os.path.join(store_space,'CatToolBoxAssessmentFiles_Data.csv')
cat_scorescorrected= os.path.join(store_space,'CatToolBoxAssessmentFiles_ScoresCorrected.csv')
...
scoresfiles=files4process.loc[files4process.filename.str.contains('Scores') & ~(files4process.filename.str.lower().str.contains('corrected'))]
rawdatafiles=files4process.loc[files4process.filename.str.contains('Assessment') & ~(files4process.filename.str.contains('Scores'))]
corrected=files4process.loc[files4process.filename.str.lower().str.contains('corrected')]
