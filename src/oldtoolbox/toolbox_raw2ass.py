...
#rsync petra@nrg-toolbox.nrg.mir:/var/www_nih_app_endpoint/html/projects/lifespan/2018*Scores* /data/intradb/tmp/box2nda_cache/endpointbak2109_0620/.
...
baknames=pd.DataFrame(os.listdir(cache_space),columns={'RawEndpointFilename'})
baknames['filenamealphanum']=baknames.RawEndpointFilename.str.replace('.csv','')
